...
/*
 * ********************************************************************************************************************
 *  Backendless SDK for JavaScript. Version: 4.0.9
 *
...
(function (factory) {
  ...
  Backendless._ajax_for_browser = function (config) {
    var cashingAllowedArr = ['cacheOnly', 'remoteDataOnly', 'fromCacheOrRemote', 'fromRemoteOrCache', 'fromCacheAndRemote'],
        cacheMethods = {
      ignoreCache: function ignoreCache(config) {
        return sendRequest(config);
      },
      cacheOnly: function cacheOnly(config) {
      ...
      remoteDataOnly: function remoteDataOnly(config) {
        return sendRequest(config);
      },
      fromCacheOrRemote: function fromCacheOrRemote(config) {
        var cachedResult = Backendless.LocalCache.get(config.url.replace(/([^A-Za-z0-9])/g, ''));
      ...
      fromRemoteOrCache: function fromRemoteOrCache(config) {
        return sendRequest(config);
      },
      fromCacheAndRemote: function fromCacheAndRemote(config) {
        var result = {},
      ...
      var cacheHandler = function cacheHandler(response) {
      ...
      var checkInCache = function checkInCache() {
  ...
  Backendless._ajax_for_nodejs = function (config) {
    ...
    if (!config.isAsync) {
      throw new Error('Using the sync methods of the Backendless API in Node.js is disallowed. ' + 'Use the async methods instead.');
    }
    ...
    var u = require('fusejs_lib/url_url.js').parse(config.url);
  ...
  function DataStore(model) {
    ...
    if ((typeof model === 'undefined' ? 'undefined' : _typeof(model)).toLowerCase() === "string") {
  ...
  DataStore.prototype = {
    _extractQueryOptions: function _extractQueryOptions(options) {
      var params = [];
    ...
    _parseFindResponse: function _parseFindResponse(response, model) {
      var _Model = model === undefined ? this.model : model;
      var result;

      var sanitizeResponseItem = function sanitizeResponseItem(response) {
    ...
    _load: function _load(url, async) {
      if (url) {
    ...
    _replCircDeps: function _replCircDeps(obj) {
      var objMap = [obj];
      var pos;
    ...
    _formCircDeps: function _formCircDeps(obj) {
      var result = new obj.constructor();
      var circDepsIDs = {};
      var iteratedObjects = [];

      var _formCircDepsHelper = function _formCircDepsHelper(obj, result) {
    ...
    _save: function _save(obj, async) {
    ...
    _remove: function _remove(objId, async) {
    ...
    _find: function _find(queryBuilder) {
    ...
    _validateFindArguments: function _validateFindArguments(args) {
      if (args.length === 0) {
        return;
      }

      if (!(args[0] instanceof Backendless.DataQueryBuilder) && !(args[0] instanceof Async)) {
        throw new Error('Invalid find method argument. ' + 'The argument should be instance of Backendless.DataQueryBuilder or Async');
      }
    },

    _parseFindArguments: function _parseFindArguments(args) {
    ...
    _findUtil: function _findUtil(dataQuery) {
      dataQuery = dataQuery || {};
    ...
    _loadRelations: function _loadRelations(parentObjectId, queryBuilder, async) {
    ...
    _validateLoadRelationsArguments: function _validateLoadRelationsArguments(parentObjectId, queryBuilder) {
    ...
    _findFirst: function _findFirst() {
    ...
    _getObjectCount: function _getObjectCount(queryBuilder, async) {
      var args = this._parseFindArguments(arguments);
      var dataQuery = args.queryBuilder ? args.queryBuilder.build() : {};
    ...
    _setRelation: function _setRelation() {
    ...
    _addRelation: function _addRelation() {
    ...
    _deleteRelation: function _deleteRelation() {
      return this._manageRelation('DELETE', arguments);
    },

    _collectRelationObject: function _collectRelationObject(args) {
      var relation = {
        columnName: args[1]
      };
    ...
    _validateRelationObject: function _validateRelationObject(relation) {
    ...
    _manageRelation: function _manageRelation(method, args) {
    ...
    _buildRelationUrl: function _buildRelationUrl(relation) {
    ...
    _bulkCreate: function _bulkCreate(objectsArray, async) {
    ...
    _bulkUpdate: function _bulkUpdate(templateObject, whereClause, async) {
    ...
    _bulkDelete: function _bulkDelete(objectsArray, async) {
    ...
    _validateBulkCreateArg: function _validateBulkCreateArg(objectsArray) {
    ...
    _validateBulkUpdateArgs: function _validateBulkUpdateArgs(templateObject, whereClause) {
    ...
    _validateBulkDeleteArg: function _validateBulkDeleteArg(arg) {
  ...
  var persistence = {
    ...
    _save: function _save(className, obj, async) {
      var responder = Utils.extractResponder(arguments);
    ...
    _getView: function _getView(viewName, whereClause, pageSize, offset, async) {
      var responder = Utils.extractResponder(arguments),
          isAsync = responder != null;
    ...
    _callStoredProcedure: function _callStoredProcedure(spName, argumentValues, async) {
      var responder = Utils.extractResponder(arguments),
          isAsync = responder != null;
    ...
    _describe: function _describe(className, async) {
  ...
  DataPermission.prototype = {
    ...
    _grantUser: function _grantUser(userId, dataObject, async) {
    ...
    _grantRole: function _grantRole(roleName, dataObject, async) {
      return this._sendRequest({
        roleName: roleName,
        dataObject: dataObject,
        responder: async,
    ...
    _grant: function _grant(dataObject, async) {
      return this._sendRequest({
        userId: '*',
        dataObject: dataObject,
        responder: async,
    ...
    _denyUser: function _denyUser(userId, dataObject, async) {
      return this._sendRequest({
        userId: userId,
        dataObject: dataObject,
        responder: async,
    ...
    _denyRole: function _denyRole(roleName, dataObject, async) {
      return this._sendRequest({
        roleName: roleName,
        dataObject: dataObject,
        responder: async,
    ...
    _deny: function _deny(dataObject, async) {
      return this._sendRequest({
        userId: '*',
        dataObject: dataObject,
        responder: async,
    ...
    _getRestUrl: function _getRestUrl(dataObject, permissionType) {
      return this.restUrl + '/' + encodeURIComponent(dataObject.___class) + '/permissions/' + permissionType + '/' + encodeURIComponent(dataObject.objectId);
    },

    _sendRequest: function _sendRequest(options) {
  ...
  UserService.prototype = {
    _wrapAsync: function _wrapAsync(async, stayLoggedIn) {
      var me = this,
    ...
    _parseResponse: function _parseResponse(data, stayLoggedIn) {
    ...
    _register: function _register(user, async) {
    ...
    _getUserRoles: function _getUserRoles(async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _roleHelper: function _roleHelper(identity, rolename, async, operation) {
      if (!identity) {
    ...
    _assignRole: function _assignRole(identity, rolename, async) {
    ...
    _unassignRole: function _unassignRole(identity, rolename, async) {
    ...
    _login: function _login(login, password, stayLoggedIn, async) {
      if (!login) {
    ...
    _getUserFromResponse: function _getUserFromResponse(user) {
    ...
    _describeUserClass: function _describeUserClass(async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _restorePassword: function _restorePassword(emailAddress, async) {
      if (!emailAddress) {
    ...
    _logout: function _logout(async) {
      var responder = Utils.extractResponder(arguments),
          isAsync = responder != null,
        ...
        if (Utils.isFunction(successCallback)) {
          ...
          onLogoutError = function onLogoutError(e) {
    ...
    _getCurrentUser: function _getCurrentUser(async) {
      if (currentUser) {
    ...
    _update: function _update(user, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _loginWithFacebook: function _loginWithFacebook(facebookFieldsMapping, permissions, stayLoggedIn, async) {
    ...
    _loginWithGooglePlus: function _loginWithGooglePlus(googlePlusFieldsMapping, permissions, container, stayLoggedIn, async) {
    ...
    _loginWithTwitter: function _loginWithTwitter(twitterFieldsMapping, stayLoggedIn, async) {
      return this._loginSocial('Twitter', twitterFieldsMapping, null, null, stayLoggedIn, async);
    },

    _socialContainer: function _socialContainer(socialType, container) {
      var loadingMsg;
      ...
      if (container) {
        ...
        container = window.open('', socialType + ' authorization', "resizable=yes, scrollbars=yes, titlebar=yes, top=10, left=10");
    ...
    _loginSocial: function _loginSocial(socialType, fieldsMapping, permissions, container, stayLoggedIn, async) {
    ...
    loginWithFacebookSdk: function loginWithFacebookSdk(fieldsMapping, stayLoggedIn, options) {
      var users = this;
    ...
    loginWithGooglePlusSdk: function loginWithGooglePlusSdk(fieldsMapping, stayLoggedIn, async) {
      var users = this;
    ...
    _sendSocialLoginRequest: function _sendSocialLoginRequest(response, socialType, fieldsMapping, stayLoggedIn, async) {
      if (fieldsMapping) {
    ...
    _isValidLogin: function _isValidLogin(async) {
    ...
    _resendEmailConfirmation: function _resendEmailConfirmation(emailAddress, async) {
  ...
  Geo.prototype = {
    ...
    _validateQueryObject: function _validateQueryObject(query) {
    ...
    _toQueryParams: function _toQueryParams(query) {
      var params = [];
    ...
    _savePoint: function _savePoint(geopoint, async) {
      ...
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
      var responderOverride = function responderOverride(async) {
        var success = function success(data) {
    ...
    _findUtil: function _findUtil(query, async) {
      var responder = Utils.extractResponder(arguments),
          isAsync = false;
    ...
    _find: function _find(query, async) {
    ...
    _loadMetadata: function _loadMetadata(geoObject, async) {
    ...
    _getClusterPoints: function _getClusterPoints(geoObject, async) {
    ...
    _relativeFind: function _relativeFind(query, async) {
    ...
    _addCategory: function _addCategory(name, async) {
      if (!name) {
    ...
    _getCategories: function _getCategories(async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _deleteCategory: function _deleteCategory(name, async) {
      if (!name) {
        throw new Error('Category name is required.');
      }
    ...
    _deletePoint: function _deletePoint(point, async) {
    ...
    _getFencePoints: function _getFencePoints(geoFenceName, query, async) {
    ...
    _getGeopointCount: function _getGeopointCount(fenceName, query, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = !!responder;
    ...
    _buildCountQueryObject: function _buildCountQueryObject(args, isAsync) {
    ...
    _runFenceAction: function _runFenceAction(action, geoFenceName, geoPoint, async) {
    ...
    _runOnStayAction: function _runOnStayAction(geoFenceName, geoPoint, async) {
    ...
    _runOnExitAction: function _runOnExitAction(geoFenceName, geoPoint, async) {
    ...
    _runOnEnterAction: function _runOnEnterAction(geoFenceName, geoPoint, async) {
      return this._runFenceAction('onenter', geoFenceName, geoPoint, async);
    },

    _getFences: function _getFences(geoFence) {
      return Backendless._ajax({
        method: 'GET',
    ...
    _distance: function _distance(lat1, lon1, lat2, lon2) {
    ...
    _updateDegree: function _updateDegree(degree) {
      degree += 180;
      while (degree < 0) {
        degree += 360;
      }
    ...
    _countLittleRadius: function _countLittleRadius(latitude) {
    ...
    _isDefiniteRect: function _isDefiniteRect(nwPoint, sePoint) {
      return nwPoint != null && sePoint != null;
    },

    _getOutRectangle: function _getOutRectangle() {
      return arguments.length === 1 ? this._getOutRectangleNodes(arguments[1]) : this._getOutRectangleCircle(arguments[0], arguments[1]);
    },

    _getOutRectangleCircle: function _getOutRectangleCircle(center, bounded) {
    ...
    _getOutRectangleNodes: function _getOutRectangleNodes(geoPoints) {
    ...
    _getPointPosition: function _getPointPosition(point, first, second) {
    ...
    _isPointInRectangular: function _isPointInRectangular(currentPosition, nwPoint, sePoint) {
    ...
    _isPointInCircle: function _isPointInCircle(currentPosition, center, radius) {
      return this._distance(currentPosition.latitude, currentPosition.longitude, center.latitude, center.longitude) <= radius;
    },

    _isPointInShape: function _isPointInShape(point, shape) {
      var count = 0;
    ...
    _isPointInFence: function _isPointInFence(geoPoint, geoFence) {
      return this._isPointInRectangular(geoPoint, geoFence.nwPoint, geoFence.sePoint) || geoFence.type === 'CIRCLE' && this._isPointInCircle(geoPoint, geoFence.nodes[0], this._distance(geoFence.nodes[0].latitude, geoFence.nodes[0].longitude, geoFence.nodes[1].latitude, geoFence.nodes[1].longitude)) || geoFence.type === 'SHAPE' && this._isPointInShape(geoPoint, geoFence.nodes);
    },
    ...
    _typesMapper: {
      ...
      'CIRCLE': function CIRCLE(fence, self) {
      ...
      'SHAPE': function SHAPE(fence, self) {
        var outRect = self._getOutRectangle(fence.nodes[0], fence.nodes[1]);
        fence.nwPoint = {
          latitude: outRect[0],
          longitude: outRect[1]
    ...
    _checkPosition: function _checkPosition(geofenceName, coords, fences, geoPoint, GeoFenceCallback, lastResults, async) {
      var self = this;
      ...
      for (var k = 0; k < self._trackedFences.length; k++) {
        ...
        if (rule) {
          var duration = self._trackedFences[k].onStayDuration * 1000,
              timeoutFuncInApp = function timeoutFuncInApp(savedK, savedCoords, duration) {
            ...
            self._timers[self._trackedFences[savedK].geofenceName] = setTimeout(callBack, duration);
              ...
              timeoutFuncRemote = function timeoutFuncRemote(savedK, savedCoords, duration, geoPoint) {
            var callBack = function callBack() {
    ...
    _mobilecheck: function _mobilecheck() {
      var check = false;
      (function (a) {
    ...
    _startMonitoring: function _startMonitoring(geofenceName, secondParam, async) {
      var self = this;
    ...
    _startGeofenceMonitoringWithInAppCallback: function _startGeofenceMonitoringWithInAppCallback(geofenceName, inAppCallback, async) {
    ...
    _startGeofenceMonitoringWithRemoteCallback: function _startGeofenceMonitoringWithRemoteCallback(geofenceName, geoPoint, async) {
      this._startMonitoring(geofenceName, geoPoint, async);
    },

    stopGeofenceMonitoring: function stopGeofenceMonitoring(geofenceName) {
      var self = this;
      //removed = [];
      if (geofenceName) {
  ...
  Utils.deepExtend(SocketProxy.prototype, {
    ...
    onSocketClose: function onSocketClose(data) {
  ...
  Subscription.prototype = {
    _subscribe: function _subscribe(async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
      var self = this;
    ...
    _startSubscription: function _startSubscription() {
      var self = this;
    ...
    _switchToPolling: function _switchToPolling() {
  ...
  Messaging.prototype = {
    _getProperties: function _getProperties(channelName, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _subscribe: function _subscribe(channelName, subscriptionCallback, subscriptionOptions, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _publish: function _publish(channelName, message, publishOptions, deliveryTarget, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _sendEmail: function _sendEmail(subject, bodyParts, recipients, attachments, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
      var data = {};
    ...
    _cancel: function _cancel(messageId, async) {
    ...
    _registerDevice: function _registerDevice(deviceToken, channels, expiration, async) {
      assertDeviceDefined();
    ...
    _getRegistrations: function _getRegistrations(async) {
      assertDeviceDefined();
    ...
    _unregisterDevice: function _unregisterDevice(async) {
      assertDeviceDefined();
    ...
    _getMessageStatus: function _getMessageStatus(messageId, async) {
      if (!messageId) {
  ...
  FilePermission.prototype = {
    ...
    _grantUser: function _grantUser(userId, url, async) {
      return this._sendRequest({
        varType: 'user',
        id: userId,
        url: url,
    ...
    _grantRole: function _grantRole(roleName, url, async) {
      return this._sendRequest({
        varType: 'role',
        id: roleName,
        url: url,
    ...
    _grant: function _grant(url, async) {
      return this._sendRequest({
        varType: 'user',
        url: url,
        state: 'GRANT',
    ...
    _denyUser: function _denyUser(userId, url, async) {
      return this._sendRequest({
        varType: 'user',
        id: userId,
        url: url,
    ...
    _denyRole: function _denyRole(roleName, url, async) {
      return this._sendRequest({
        varType: 'role',
        id: roleName,
        url: url,
    ...
    _deny: function _deny(url, async) {
      return this._sendRequest({
        varType: 'user',
        url: url,
        state: 'DENY',
  ...
  Files.prototype = {
    ...
    _saveFile: function _saveFile(path, fileName, fileContent, overwrite, async) {
    ...
    _upload: function _upload(files, path, overwrite, async) {
      async = Utils.extractResponder(arguments);
    ...
    _listing: function _listing(path, pattern, recursively, pagesize, offset, async) {
      var responder = Utils.extractResponder(arguments),
          isAsync = responder != null,
    ...
    _renameFile: function _renameFile(oldPathName, newName, async) {
    ...
    _moveFile: function _moveFile(sourcePath, targetPath, async) {
    ...
    _copyFile: function _copyFile(sourcePath, targetPath, async) {
      this._checkPath(sourcePath);
      this._checkPath(targetPath);
    ...
    _doAction: function _doAction(actionType, parameters, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = !!responder;
    ...
    _remove: function _remove(fileURL, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _exists: function _exists(path, async) {
      if (!path || !Utils.isString(path)) {
        throw new Error('Missing value for the "path" argument. The argument must contain a string value');
      }
    ...
    _removeDirectory: function _removeDirectory(path, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
    ...
    _getFileCount: function _getFileCount(path, pattern, recursive, countDirectories, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = !!responder;
    ...
    _validateCountQueryObject: function _validateCountQueryObject(query) {
  ...
  Commerce.prototype = {
    ...
    _validatePlayPurchase: function _validatePlayPurchase(packageName, productId, token, async) {
    ...
    _cancelPlaySubscription: function _cancelPlaySubscription(packageName, subscriptionId, token, Async) {
      if (arguments.length < 3) {
    ...
    _getPlaySubscriptionStatus: function _getPlaySubscriptionStatus(packageName, subscriptionId, token, Async) {
      if (arguments.length < 3) {
        throw new Error('Package Name, Subscription Id, Token must be provided and must be not an empty STRING!');
      }
  ...
  Events.prototype = {
    ...
    _dispatch: function _dispatch(eventname, eventArgs) {
  ...
  Cache.prototype = {
    ...
    _put: function _put(key, value, timeToLive, async) {
      if (!Utils.isString(key)) {
        throw new Error('You can use only String as key to put into Cache');
      }

      if (!(timeToLive instanceof Async)) {
        if ((typeof timeToLive === 'undefined' ? 'undefined' : _typeof(timeToLive)) === 'object' && !arguments[3]) {
          async = timeToLive;
          timeToLive = null;
        } else if ((typeof timeToLive === 'undefined' ? 'undefined' : _typeof(timeToLive)) !== ('number' || 'string') && timeToLive != null) {
      ...
      var responder = Utils.extractResponder([async]),
          isAsync = false;
    ...
    _expireIn: function _expireIn(key, seconds, async) {
    ...
    _expireAt: function _expireAt(key, timestamp, async) {
    ...
    _cacheMethod: function _cacheMethod(method, key, contain, async) {
      if (!Utils.isString(key)) {
    ...
    _contains: function _contains(key, async) {
    ...
    _remove: function _remove(key, async) {
  ...
  var Counter = function Counter(name, restUrl) {
  ...
  Counter.prototype = {
    _nameValidation: function _nameValidation(name) {
      if (!name) {
    ...
    _implementMethod: function _implementMethod(method, urlPart, async) {
      var responder = Utils.extractResponder(arguments);
    ...
    _implementMethodWithValue: function _implementMethodWithValue(urlPart, value, async) {
      if (!value) {
    ...
    _incrementAndGet: function _incrementAndGet(async) {
    ...
    _getAndIncrement: function _getAndIncrement(async) {
    ...
    _decrementAndGet: function _decrementAndGet(async) {
    ...
    _getAndDecrement: function _getAndDecrement(async) {
    ...
    _addAndGet: function _addAndGet(value, async) {
    ...
    _getAndAdd: function _getAndAdd(value, async) {
    ...
    _compareAndSet: function _compareAndSet(expected, updated, async) {
  ...
  Logging.prototype = {
    ...
    fatal: function fatal(message, exception) {
  ...
  CustomServices.prototype = {
    ...
    _invoke: function _invoke(serviceName, method, parameters, async) {
      var responder = Utils.extractResponder(arguments);
      var isAsync = responder != null;
  ...
  var DataQuery = function DataQuery(args) {
    args = args || {};
  ...
  DataQuery.prototype = {
    ...
    addOption: function addOption(name, value) {
      this.options = this.options || {};
  ...
  var PagingQueryBuilder = function PagingQueryBuilder() {
  ...
  PagingQueryBuilder.prototype = {
    ...
    prepareNextPage: function prepareNextPage() {
      this.setOffset(this.offset + this.pageSize);

      return this;
    },

    preparePreviousPage: function preparePreviousPage() {
  ...
  var DataQueryBuilder = function DataQueryBuilder() {
  ...
  DataQueryBuilder.prototype = {
    ...
    setWhereClause: function setWhereClause(whereClause) {
    ...
    setRelated: function setRelated(relations) {
      this._query.setOption('relations', Utils.castArray(relations));

      return this;
    },

    getRelationsDepth: function getRelationsDepth() {
      return this._query.getOption('relationsDepth');
    },

    setRelationsDepth: function setRelationsDepth(relationsDepth) {
  ...
  var LoadRelationsQueryBuilder = function LoadRelationsQueryBuilder(RelationModel) {
    this._query = new DataQuery();
  ...
  LoadRelationsQueryBuilder.prototype = {
    /** @deprecated */
    setRelationName: function setRelationName(relationName) {
  ...
  var GeoQuery = function GeoQuery(args) {
    args = args || {};
  ...
  GeoQuery.prototype = {
    ...
    setClusteringParams: function setClusteringParams(westLongitude, eastLongitude, mapWidth, clusterGridSize) {
